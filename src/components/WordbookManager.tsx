    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="rounded-lg bg-white p-4 shadow-lg sm:p-6">
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <h2 className="text-xl font-bold text-gray-800 sm:text-2xl">我的单词本</h2>
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
            <div className="grid grid-cols-4 items-center rounded-lg bg-gray-100 p-1 sm:mr-2">
              <button
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-green-100 px-4 py-2 text-green-700 transition-colors hover:bg-green-200 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-400 sm:w-auto"
            >
            ...
            <button
              onClick={exportToTXT}
              disabled={filteredWords.length === 0}
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-purple-100 px-4 py-2 text-purple-700 transition-colors hover:bg-purple-200 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-400 sm:w-auto"
            >
              <Download className="w-4 h-4" />
              导出TXT
            </button>
        ...
        {showFilters && (
          <div className="mb-6 rounded-lg bg-gray-50 p-4">
            ...
            <div className="mt-4 flex justify-end">
              <button
                onClick={clearFilter}
                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-gray-800 sm:text-base"
              >
                <X className="w-4 h-4" />
                清除筛选
              </button>
